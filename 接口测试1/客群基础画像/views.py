...
# 测试请求类
class FetchDataFromAPI(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            if data_value:
                ...
                url2 = f"http://39.102.128.14:8080/mx-data/api/request/v1/tiuser?{data_value}"
            # 直接将获取到的数据返回给前端
                headers = {
                    "Content-Type": "application/json"  # 确保服务器理解为 JSON 请求
                }
                # 和上面的to_sign的内容要保持一致
                data2 = '{"projectId":2024012301,"type":2,"id":"9022603","data":{"timeType":1,"startTime":1713283200,"endTime":1713369600}}'
